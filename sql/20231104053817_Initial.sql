...
(
    ...
    CONSTRAINT "PK_EFMigrationsHistory" PRIMARY KEY
(
    "MigrationId"
)
    );
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "EFMigrationsHistory" WHERE "MigrationId" = '20231104053817_Initial') THEN
...
NOT EXISTS(SELECT 1 FROM "EFMigrationsHistory" WHERE "MigrationId" = '20231104053817_Initial') THEN
    ...
    VALUES ('20231104053817_Initial', '7.0.13');
END IF;
END $EF$;
COMMIT;
